package eurekaclient.eurekaclient.route;
...
//		log.info("servletPath:{}", servletPath);
	...
	private Map<String, ZuulProperties.ZuulRoute> locateRoutesFromRedis() {
		...
		System.out.println("------------locateRoutesFromRedis-------------");
		
//		List<ZuulRouteVO> results = JSON.parseArray(redisTemplate.opsForValue().get(RedisKeyConstants.ZUUL_ROUTE_KEY),
//				ZuulRouteVO.class);
